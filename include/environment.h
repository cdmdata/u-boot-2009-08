...
#  error "Need to define CONFIG_ENV_MC_OFFSET when using CONFIG_ENV_IS_IN_MMC"
# endif
# ifndef CONFIG_ENV_ADDR
#  define CONFIG_ENV_ADDR	(CONFIG_ENV_MMC_OFFSET)
# endif
# ifndef CONFIG_ENV_MMC_OFFSET
#  define CONFIG_ENV_MMC_OFFSET (CONFIG_ENV_ADDR)
# endif
# ifdef CONFIG_ENV_OFFSET_REDUND
#  define CONFIG_SYS_REDUNDAND_ENVIRONMENT
# endif
