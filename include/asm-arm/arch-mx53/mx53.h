...
/*
 * IPUv3M 128M from 0x18000000 - 0x20000000
 */
#define IPU_CM_REG_BASE		0x1E000000
#define IPU_IDMAC_BASE		0x1e008000
#define IPU_DI0_BASE		0x1E040000
#define IPU_DI1_BASE		0x1E048000
#define IPU_DC_BASE		0x1E058000
#define IPU_DMFC_BASE		0x1e060000
#define IPU_CPMEM_REG_BASE	0x1F000000
#define IPU_SRM_REG_BASE	0x1f040000
#define IPU_DC_TEMPLATE_BASE	0x1f080000
...
//(1/4 + 6) * 96 / 1 = 600
#define DP_OP_600       MAKE_OP(6, 1)
#define DP_MFN_600      1
#define DP_MFD_600      (4 - 1)
#define DP_CTL_600	(0x1220 | DP_CTL_RESTART | DP_CTL_BRMO)
